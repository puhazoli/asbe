...
__all__ = ['RandomAcquisitionFunction', 'UncertaintyAcquisitionFunction', 'TypeSAcquistionFunction',
           'EMCMAcquisitionFunction', 'RandomAssignmentFunction', 'MajorityAssignmentFunction', 'random_batch_sampling',
           'uncertainty_batch_sampling', 'type_s_batch_sampling', 'expected_model_change_maximization', 'ASLearner',
           'estimator_type', 'ITEEstimator', 'variance_based_assf']
...
class UncertaintyAcquisitionFunction(BaseAcquisitionFunction):
    def calculcate_metrics(self, model, dataset):
